...
*Graduation Project by Team: The Extractors | مشروع تخرج فريق The Extractors*
...
هذه الأداة هي نظام أمني متكامل يحاكي "رحلة المستخدم الكاملة" (Full User Journey) لمختبر الاختراق. تم تصميمها لتبسيط وأتمتة العمليات المعقدة، بدءاً من الاستطلاع وتجاوز الجدران النارية، مروراً بفحص المنافذ وتحليل الثغرات، ووصولاً إلى اقتراح وتنزيل أكواد الاستغلال المناسبة.
