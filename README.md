...
*Graduation Project by Team: The Extractors*
...
هذه الأداة هي نظام أمني متكامل يحاكي "رحلة المستخدم الكاملة" لمختبر الاختراق. تم تصميمها لأتمتة العمليات المعقدة بدءاً من الاستطلاع وتجاوز الجدران النارية، مروراً بفحص المنافذ وتحليل الثغرات، ووصولاً إلى اقتراح وتنزيل أكواد الاستغلال المناسبة.

---

## 💻 Interface Concept | شكل الواجهة
The tool features an interactive CLI with a new Port Selection menu:
